...
const percakapanData = [
  ...
  },
  {
    id: 3,
    topik: '何時にどこにしますか？',
    tema: 'Putuskan di mana jam berapa?',
    audio: 'https://www.irodori.jpf.go.jp/assets/data/elementary01/audio/07/Y_[07-03]_kiku3.mp3',
    dialog: [
  ...
  },
  {
    id: 5,
    topik: '日本に来てどのぐらいですか',
    tema: 'Sudah berapa lama sejak?',
    audio: 'https://www.irodori.jpf.go.jp/assets/data/elementary01/audio/01/Y_[01-09]_kiku4.mp3',
    dialog: [{ speaker: 'A', text: 'Ａ：日本に来て、どのぐらいに なりま す か？<br/>Ｂ：私は、先月、来ました。<br/>Ａ：そうですか。少し慣れ ました か？<br/>Ｂ：まだ、ちょっと……。' }],
    arti: 'A: Mmm, acara tanggal sepuluh, dari jam berapa?. <br/>B: Mulai jam 5, tapi Karyawan datanglah 30 menit sebelumnya. <br/>B: Hee..Oke, setengah lima ya, saya faham. <br/>B: Ok, ditunggu ya.',
  },
  {
    id: 6,
    ...
    audio: 'https://www.irodori.jpf.go.jp/assets/data/elementary01/audio/06/Y_[06-12]_kiku.mp3',
    dialog: [
      { speaker: 'Yumiko', text: 'はい。アジア食材バグースです。' },
      { speaker: 'Tanaka', text: 'すみません。そちらに行きたいんですが、どう行ったらいいですか？今、さくら駅の北口にいます。' },
      { speaker: 'Yumiko', text: '駅の北口ですね。駅の前の道を渡って、銀行とコンビニの間の道をまっすぐ行ってください。' },
      { speaker: 'Noriko', text: 'はい。' },
      { speaker: 'Yumiko', text: 'それから、１つ目の信号を右に曲がってください。' },
      { speaker: 'Noriko', text: '右ですね。' },
      { speaker: 'Yumiko', text: 'はい。その道をまっすぐ行って、2つ目の角を左に曲がってください。' },
      { speaker: 'Noriko', text: 'はい。' },
      { speaker: 'Yumiko', text: 'そうすると、黒いビルが見えます。その隣です。' },
      { speaker: 'Tanaka', text: '黒いビルの隣ですね。わかりました。ありがとうございます。' },
      { speaker: 'Yumiko', text: 'お待ちしております。' },
    ],
    arti: 'A: Ya. Ini adalah Toko Bahan Makanan Asia "Bagus". ',
  },
  {
    id: 7,
    topik: '何が好きですか',
